module app {
    ...
    admin_note = {
        saas_mgmt_name = "example" #This is the name in Torii
        ...
        lifecycle_automations = { 
            provisioning = {  #This is how users are provisioned to the app
                ...
                link = "https://automation.com" #this is the link to where the automation is provisioned this can just be the app url
                }
        ...
        last_access_audit_date = "string" #this is when access to the app was last audited. This should be done upon creation
